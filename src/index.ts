...
// app.get("/", (req, res) => {
//   res.send("🚀 Backend connected to Firestore!");
// });
...
//   });
// });
// // Add this to your routes in backend index.ts
...
//     const docRef = await firestore.collection("products").add({ name, price });
...
//   console.log("GET  /products (protected)");
